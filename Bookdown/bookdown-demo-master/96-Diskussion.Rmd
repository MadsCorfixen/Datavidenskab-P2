...
Når en population er lille nok kan man bestemme alle bootstrap stikprøver deterministisk. I praksis er stikprøvestørrelsen typisk for stor til det kan lade sig gøre, derfor tager man en tilfældig stikprøveudtagning. Dette kaldes for "the Second Bootrap Principle".Ved brug af denne form for stikprøvudtagning (monte carlo sampling) vil der være en uønsket variabilitet, hvilket kan løses ved at øge størrelsen på antallet af stikprøveudtagninger. Derfor når computerkraften ikke kan klare stor nok stikprøveudtagning på de $10,000$ skaber det en variabilitet for hver gang metoden bliver kørt. [@MathStat, side 134-135]
