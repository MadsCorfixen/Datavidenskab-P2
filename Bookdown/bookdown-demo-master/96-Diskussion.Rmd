...
Når en population er lille nok kan man bestemme alle bootstrap-stikprøver og permutationer ( _resamples_ ) deterministisk. I praksis er stikprøvestørrelsen typisk for stor til, at det kan lade sig gøre, derfor tages en tilfældig delmængde af mulige _resamples_. Dette kaldes for Monte Carlo simulering. Ved brug af denne form for _resampling_ vil der være en uønsket variabilitet, hvilket kan løses ved at øge størrelsen på antallet af _resamples_. Derfor, når computerkraften ikke kan klare et stort nok antal _resamples_ på de $10,000$, skaber det en variabilitet for hver gang metoden bliver kørt, [@MathStat, s. 134-135].
