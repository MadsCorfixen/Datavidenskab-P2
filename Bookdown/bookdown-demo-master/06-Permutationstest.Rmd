...
__FIXME:__ (THOMAS: I stedet for populationer, så udtag stikprøver fra de i forvejen simulerede populationer og plot dem. [@ref] eventuelt til simuleringen)
...
```{r figurpop1, fig.align="center", echo=FALSE, fig.cap= "Population 1 genereret med en betafordeling hvor n = 10,000, &alpha; = 2, &beta; = 8"}
hist(Pop1, main = "", ylab = "", xlab = "")
```
```{r figurpop2, fig.align="center", echo=FALSE, fig.cap= "Population 2 genereret med en betafordeling hvor n = 10,000, &alpha; = 8, &beta; = 2"}
hist(Pop2, main = "", ylab = "", xlab = "")
```

Nulhypotesen er at $H_0: \mu_1 - \mu_2 = 0$ og den alternative hypotese er $H_1 : \mu_1 - \mu_2 \neq 0$. Denne nulhypotese undersøges ved hjælp af en uparret t-test. Der udtrækkes en stikprøve fra hver population, og udfra disse udføres der to-sidet uparret t-test, ved hjælp af den indbyggede funktion `t.test`.
```{r}
#To stikprøver trukket fra populationerne
Stik1 <- sample(Pop1, size = 1000)
Stik2 <- sample(Pop2, size = 1000)
