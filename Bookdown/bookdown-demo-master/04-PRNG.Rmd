...
Dette afsnit beskriver teoretisk hvorledes lineær kongruens generator på baggrund af et arbitrær parameter kan generer en sekvens af tilfældige tal, som kan være unifor fordelte. __FIXME__ (Er gives et eks. på uniform fordelte tal, kan den også laves standard normalfordelte tal? - som box-muller)
