...
_P_-værdien ligger i intervallet $[0,1]$, $p_{tosidet} \in [0,1]$, hvor $p_{mindre} + p_{større} = 1$ . Vælges $\min (p_{mindre}, ~p_{større})$ fås en ensidet _p_-værdien. Derfor multipliceres der med $2$, for at opnå den tosidede _p_-værdi. Se figur __FIXME__ INDSÆT PÆN FIGUR THOMAS.
