...
_P_-værdien ligger i intervallet $[0 ; 1]$, $p_{tosidet} \in [0 ; 1]$, hvor $p_{mindre} + p_{større} = 1$ . Eftersom den største værdi $min (p_{mindre}, p_{større)$ kan give er $0.5$ multipliceres det med $2$.

$p_{mindre}$ er lav i de tilfælde, hvor $t^* < \bar Z$ ofte er tilfældet. Ligeledes gør det sig gældende, at $p_{større}$ er lav i de tilfælde, hvor $t^* > \bar Z$ ofte er tilfældet. $min$ bliver benytter eftersom, der undersøges, hvor ofte mere ekstreme tilfælde optræder end den observerede teststørrelse. 

Hvis $p_{mindre}$ eller $p_{større}$ er mindre end $\frac{\alpha}{2}$ forkastes $H_0$, da der er en signifikant forskel i middelværdierne. 
