...
I outputtet _head(S_pi, 3)_ ses et eksempel på tre af de permuterede teststørrelser. På figur \@ref(fig:permmeanhist) illusteres fordelingen af de permuterede teststørrelser.
...
hist(S_pi, main = "", ylab = "Antal observationer", 
                            xlab = "Forskel i middelværdier")
abline(v = mean(S_pi), col = "green")
