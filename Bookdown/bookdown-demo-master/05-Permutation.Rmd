...
type_1_fejl <- replicate(reps, {
  ...
  p_vaerdi <- (ekstreme_vaerdier+1)/(length(mean_list)+1)
...
__FIXME:__ (What...? Ud af 100 gange, er den falsk i 8 af tilfældene og sand i 89, men 89+8=97. Hvor er de sidste 3? Fejlen sker kun ved nogle seeds...)
