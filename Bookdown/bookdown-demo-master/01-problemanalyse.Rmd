...
Ordet _statistik_ stammer tilbage fra det lantinske _statisticum collegium_ ("statsrådgiver") og italienske _statista_ ("statsmand" eller "politiker"). At statistik netop stammer derfra, giver god mening, under anskueelse af betydningen af disse to ord og den tidlige anvendelse af statestik. I takt med udviklingen af suverænitetsstaterne, steg behovet for at registrerer befolkningen og dennes tilhøresforhold. Derfor anvendte statsrådgiver og statsmænd, statistik til at beskrive staten, særligt demografien. Senerere blev dette udvidet til at indsamle flere informationer, og ligeledes at analysere og fortolke disse ved hjælp af statistik. 
Selve ordet statistik fandt sin vej til Danmark i 1749, via den tyske statistiker Gottfried Achenwall, som var den første som anvendte ordet _statistik_, til at beskrive sine studier indenfor netop statistik. \ref(https://en.wikipedia.org/wiki/History_of_statistics) \ref(https://da.wikipedia.org/wiki/Statistik) 

Udgangspunktet for statistik kommer fra sandsynlighedsregning og læreren derfra. I statistikken arbejdes der ligeledes med udfald og tilfældigheder, men overordnet beskæftiger statistikken sig med analyse af indsamlet data. Der er igennem tiderne i stor udstrækning refereret til mange af de samme matematikere. 
\ref(https://da.wikipedia.org/wiki/Sandsynlighedsregning)

Statistik blev i begyndelsen anvendt som en videnskablig metode til behandling af numerisk data. Særligt blev det anvendt som en metode til grafisk fremstilling af data. Med tiden udvikledes anvendelses mulighederne sig, og således at det var muligt at beregne statistiske mål, eksempelvis middelværdi. Udviklingen og anvendelsen af statistik er op gennem årene blevet bredere og i langt højere grad. Særligt udviklingen af computeren har vævret med til at gøre anvendelsen af kompliceret statistiske beregninger hurtigere, mere præcise og mere tilgængeligt. Anvendelses områderne for statistik har ligeledes udviklet sig, fra i begyndelsen at være noget staten anvendet til styring af økonomi og befolknings indblik, til stor set at være repræsenteret i alle større hverv i dag. Den moderne statistik kan beskrives som evnen til at drage konklusioner om generelle tilfælde, _population_, på baggrund af enkelte tilfælde, _stikprøver_. \ref(https://da.wikipedia.org/wiki/Statistik) 

Statistisk videnskab giver tre overordnet begreber, til anvendelsen. _Design_(Skal jeg oversætte disse termer, eller er det fint nok at de står på engelsk?), som omhandler planlægningen og tilvejebringelsen af data til den undersøgelse der ønskes foretaget. _Describption_, når data er indsamlet skal der laves en sammenfatning over data og initial analyse, således der på et oplyst grundlag kan træffes beslutning om hvorledes data skal behandles yderligere. _Inference_, påbaggrund af data analyse er det muligt at drage konklusioner om den population der ønskes undersøgt. Forudsigelser som laves på baggrund af data, kaldes for statistisk inferens.   \ref(Asta bog s~15-16)
