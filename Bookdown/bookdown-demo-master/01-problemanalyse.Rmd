...
Den anden form for statistisk infernes er hypotesetest. I hypotesetest opstilles først en nulhypotese, __FIXME disse kommer ikke ud i html, som mat skrift__  $H_0$, og en modhypotese, __FIXME disse kommer ikke ud i html, som mat skrift__ $H_1$. Målet er at indsamle nok evidens imod __FIXME disse kommer ikke ud i html, som mat skrift__ $H_0$, så den kan forkastes, og man er dermed blevet klogere på populationen. 
