...
For at en t-test giver et korrekt resultat, er der visse krav, der skal være opfyldt, heriablandt, at stikprøven skal være normalfordelt. Er disse krav ikke opfyldt, giver testen et misvisende restultat, hvilket i dette afsnit vil eftervises ved hjælp af en permutationstest i R. Først gives en kort introduktion til permutationer, herefter en forklaring af, hvad en permutationstest er, og til sidst modbevises de resultater, der blev opnået i det foregående afsnit.
...
Som eksempel er en mulig permutation, $\pi_1$, af $A = \{1, 2, 3\}$ givet ved $A_{\pi_1} = \{2, 1, 3\}$, og der er i alt $|A| = 3! = 1 \cdot 2 \cdot 3 = 6$ mulige permuteringer af listen. 

## Permutationstest



## Modbevis af resultater fra Afsnit X.Y
