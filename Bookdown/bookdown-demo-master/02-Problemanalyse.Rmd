...
En binomialfordeling bliver genereret ud fra sandsynligheder med to udfald, success og fiasko. I den binomiale fordeling gives en _size_ som er antallet af eksperimenter, samt en sandsynlighed for succes, angivet med _prob_. Det vil altså sige, at der foretages et eksperiment af en given størrelse samt en sandsynlighed for succes. For hver gentagelse af eksperimentet optælles andelen af successer, som minimalt kan være $0$ og maksimalt eksperimentstørrelsen. Andelen af successer fra hvert eksperiment illustreres herefter i et histogram.
