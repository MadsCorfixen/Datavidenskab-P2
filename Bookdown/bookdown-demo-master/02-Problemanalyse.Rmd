...
Det følgende afsnit er baseret på [@ASTAkursus1] og [@ASTAbog, s.16-17] __FIXME__ (ASTAbog er 4. udgave, så ved ikke hvordan det stemmer med side tal.)
...
Det følgende afsnit er baseret på [@ASTAkursus2], [@ASTAkursus3] og [@ASTAbog, s.16-17]. __FIXME__ (ASTAbog er 4. udgave, så ved ikke hvordan det stemmer med side tal.)
