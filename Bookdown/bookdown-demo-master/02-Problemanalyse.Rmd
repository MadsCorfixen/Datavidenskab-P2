...
__FIXME:__ (Mere forklaring til denne figur)
...
Eftersom *p*-værdien er ```r p``` $> \alpha=0.05$, forkastes $H_0$ ikke. Havde *p*-værdien derimod været mindre end $0.05$ ville det medføre, at $H_0$ forkastes og det ville formodes, at $H_0$ ikke er korrekt for populationen.
