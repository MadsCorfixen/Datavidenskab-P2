...
Den anden form for statistisk infernes er hypotesetest. I hypotesetest opstilles først en nulhypotese, $H_0$, og en alternativ hypotese, $H_1$. Formålet med en hypotesetest er at indsamle nok evidens imod $H_0$, så den kan forkastes, hvilket giver ny viden omkring populationen.
