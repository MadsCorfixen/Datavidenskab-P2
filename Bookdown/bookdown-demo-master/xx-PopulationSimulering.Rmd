...
__FIXME:__ (Vis fordelingens densitet)

```{r VSHS, echo=FALSE, fig.cap= "To skæve populationer genereret fra en betafordeling"}
par(mfrow=c(1,2))
hist(pop_vs, main = "Venstreskæv population", ylab = "", xlab = "", prob = TRUE)
lines(density(pop_vs), col="red", lwd=2)
hist(pop_hs, main = "Højreskæv population", ylab = "", xlab = "", prob = TRUE)
