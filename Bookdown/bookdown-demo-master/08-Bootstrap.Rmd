...
3. Estimerings nøjagtighed
For jackknife estimater er standardfejlen den samme for en given stikprøve. Dette er ikke tilfældet for bootstrap som har forskellige resultater hvergang den bruges. Derudover returnerer jackknife en smule større estimerede standardfejl.
...
Ligesom for mange andre statistike metoder til at infere estimater, har stikprøve størrelsen en stor betydning for nøjagtigheden af disse estimater. Det samme gør sig tilfældet for bootstrap-metoden. (figur 5.18)

FIXME skal oversættes til forståelgit dansk : The ordinary bootstrap tends not to work well for statistics such as the median or other quantiles that depend heavily on a small number of
