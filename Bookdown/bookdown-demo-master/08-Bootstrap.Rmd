...
De to resampling metoder, bootstrap og jackknife, er nu blevet vist, og afprøvet praktisk i R. I det følgende afsnit vil de to metoder sammenlignes på tværs af forskellige kategorier. Dette gøres for at undersøge deres svagheder og styrker, samt at se hvornår hvilken er mest oplagt at bruge. 
...
Jackknife metoden er nyttig til at opfange outliers i ens data, samt god til at undersøge ens estimatores standardafvigelser.
...
Ligesom for mange andre statistike metoder til at infere estimater, har stikprøve størrelsen en stor betydning for nøjagtigheden af disse. Det samme gør sig tilfældet for jackknife, endda endnu mere her, da stikprøven størrelsen har en afgørende betydning for hvor mange resamplings der kan foretages. 

Bootstrap:\
Se kilde [@BootvsJack afsnit, 5.8] for forklarende figurer.

Bootstrap-metodens nøjagtighed kan undersøges ved for eksempel estemering af stikprøve middelværdien. Ved en stor stikprøve størrelse, er bootstrap nøjagtigheden høj. 

Man skal dog være opmærksom på ved sådanne estimeringer, at bootstrap stikprøven ikke giver et bedre bud på populationens middelværdi end stikprøvens, da bootstrap-stikprøven følger den orginiale stikprøves fordeling. Derfor bruges bootstrap altså ikke til at drage konklusiner om ens population, men derimod den valgte parametre estimats tendenser, såsom standardfejlen, forventingsrethed eller konfidensintervaller. [@BootvsJack s. 114]

Igen gør det sig gældende at stikprøve størrelsen har en stor betydning for nøjagtigheden af bootstrap. End for lav stikprøvestørrelse vil i mange sammenhænge vise sig at være problematisk. 
...
Alt i alt, er bootstrap metoden i næsten altid, udover små nichetilfælde [@PairwiseAgreementMeasures], at foretrække frem for jackknifing. Især nu til dags hvor computerkraft oftest ikke noget der skal overvejes i statistisk inferens. 
