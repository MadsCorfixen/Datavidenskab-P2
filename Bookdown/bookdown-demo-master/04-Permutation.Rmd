...
På figur \@ref(fig:permmeanhist) illusteres fordelingen af alle permutationernes teststørrelse.

```{r permmeanhist, fig.cap = "Permutationsfordelingen af alle teststørrelserne. Den blå linje viser den originale observeret forskel i middelværdierne."}
