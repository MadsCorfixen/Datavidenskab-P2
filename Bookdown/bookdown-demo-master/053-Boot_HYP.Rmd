...
Der udtages en bootstrap-stikprøve for $Z$ af $n$ observationer med tilbagelægning, som betegnes $Z^*$. På baggrund af bootstrap-stikprøven for $Z$, kan der nu udregnes $B$ nye teststørrelser, $t^*_i = \bar{Z^*_i}$, hvor $Z^*_i = [z^*_{1,i},~z^*_{2,i},~...,~z^*_{n,i}]$, .
