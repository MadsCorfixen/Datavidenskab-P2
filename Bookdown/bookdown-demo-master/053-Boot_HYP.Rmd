...
Hvis $\text{p}_{_{tosidet}}<\alpha$ forkastes $H_0$.
...
par(mfrow = c(1,2))
hist(stik1, main = "", xlab = "Stikprøve 1", ylab = "Antal observationer")
hist(stik2, main = "", xlab = "Stikprøve 2", ylab = "Antal observationer")
