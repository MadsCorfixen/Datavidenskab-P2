...
knitr::include_graphics("images/LCG_eksempel.svg")
```
...
Her ses et eksempel på en LCG generator. Der angives værdier for parametrerne, og rekursionen køres igennem m antal gange, i dette tilfælde 100 gange. Dette er også et eksempel på en LCG sekvens med en periode på 16. Perioden fortæller, hvor mange værdier generatoren returnerer inden den gentager sig selv.  
