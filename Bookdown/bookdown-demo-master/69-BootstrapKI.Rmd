...
En intuitiv fremgangsmåde til at bestemme et konfidansinterval ved percentiler er, at bruge det $b \cdot \frac{\alpha}{2}$-te og $b(1-\frac{\alpha}{2})$-te percentil, hvor $b$ er antallet af bootstrap repitationer. Derved er formlen for et konfidensinterval på baggrund af percentiler:

$\text{KI} = [\theta^{*}_{(\alpha/2)}, \theta^{*}_{(1-\alpha/2)}]$
