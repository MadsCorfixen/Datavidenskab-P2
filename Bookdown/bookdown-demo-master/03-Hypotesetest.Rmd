...
```{r}
tabel_fejltyper <- matrix(c("Korrekt", "Type 2-fejl", "Type 1-fejl", "Korrekt"), nrow = 2, ncol = 2, 
                          dimnames = list(konklusion = c("H_0", "H_1"), virkelighed = c("H_0", "H_1")))
# dimnames = 

tabel_fejltyper
```

FIXME: Tegn en pæn tabel.
