...
Ved en hypotesetest undersøges, hvorvidt der er en differencen mellem observerede værdier og forventede værdier, hvis $H_0$ er sand.
...
Teststørrelsen findes ofte som antallet af standardafvigelser, den observerede værdi, $\hat \theta$, ligger fra den forventede værdi $\theta_0$. Teststørrelsen benævnes i dette tilfælde $t_{obs}$.
...
Derudover benyttes testtørrelsen til at udregne _p_-værdien, som er sandsynligheden for at få en teststørrelse, der er lige så eller mere ekstrem end $t_{obs}$, hvis $H_0$ er sand.
