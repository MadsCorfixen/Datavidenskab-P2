...
I nogle tilfælde er det ikke muligt at overholde alle de pågældende antagelser der hører til en t-test når der udføres statistisk inferens. Når dette sker, kan det ikke altid antages at resultaterne er retvisende. I dette afsnit vil det vises, hvad der kan ske, hvis ens stikprøve ikke er normalfordelt, når der arbejdes med en uparret t-test. 
...
Det fremgår at i ```r pctf```$\%$ af tilfældene ligger den observerede forskel i middelværdierne uden for konfidensintervallet. Dette stemmer ikke overens med antagelsen om at $5\%$ burde ligge udenfor.

Derudover kan det antages, at stikprøverne påvirker resulatet i en stor grad, eftersom hvor repræsentative de er for populationen er altafgørende for t_testens dækningsgrad. Foretages t-testen på fire nye stikprøver, som ses i figur \@ref(fig:piettest_4), fremgår der store variationer. 

```{r piettest_4, fig.align="center", fig.cap= "Andel af succeser og fiaskoer ved fire stikprøver", echo=FALSE}
set.seed(7)
x <- 4
...
Det fremgår altså at der er en stor variation, og det vil derfor være interessant at undersøge den gennemsnitslige afvigelse på de to skæve populationer.

Dette gøres ved at replikere koden til figur \@ref(fig:piettest) $100$ gange, hvorefter den gennemsnitslige afvigelse regnes ud.
...
Det fremgår altså, at t-testen kun har en sand dækningsgrad på ```r daekningsgrad```%, hor den antagede er $95\%$. Det fremgår at i ```r gns_pct```$\%$ af tilfældene ligger den observerede forskel i middelværdierne uden for konfidensintervallet. Dette stemmer stadig ikke overens med antagelsen om at $5\%$ burde ligge udenfor. Konklusionen er derfor at en t-test udført på ikke-normalfordelte stikprøver ikke nødvendigvis giver et retvisende resultat.
