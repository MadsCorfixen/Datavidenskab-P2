...
FIXME Mads tjek lige den her def står rigtigt haha
>```{definition}
> En stokastisk variabel er en funktion, $X$, som til et hvert udfald af et eksperiment, $\omega >\in \Omega$, $X(\omega) \in E$. $E$ kaldes for udfaldsrummet. 
>```
