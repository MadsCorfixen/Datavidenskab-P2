...
En stokatisk variabel, $X$, er en funktion, som afbilleder over i mulige udfald af et eksperiment. Ved at definere en stokastisk variabel, gøres det nemmere at arbejde med hændelser og deres sandsynligheder. Derudover er stokastiske variabler særligt anvendelige i de tilfælde hvor et udfald ikke er defineret ved en talværdi, eksempelvis plat eller krone. [@Stokvar]

FIXME Ide: Dette i en definitionsboks. 
...
$X(\text{sten}) = 0$, $X(\text{saks}) = 1$ og  $X(\text{papir}) = 2$

Stokastiske variabler kan beskrives som _diskrette_ eller _kontinuerte_, hvilket afhænger af de mulige udfald. Der skelnes om disse udfald er tællelige eller utællelige, hvilket uddybes i et senere afsnit. [@Stokvar] 
