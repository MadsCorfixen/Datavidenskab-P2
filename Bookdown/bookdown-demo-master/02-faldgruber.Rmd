...
For at bestemme, hvor stor en stikprøve der skal benyttes, for at stikprøvegennemsnittet bliver normalfordelt, benyttes 'Cochrans regel', som siger, at stikprøvestørrelsen, $n$, skal ligge i intervallet $[25 \cdot (\mathrm{skævhed})^2, 100 \cdot (\mathrm{skævhed})^2]$. Hvor skævhed er en numerisk værdi der symboliserer hvor "lang" halen er, i en venstre- eller højreskæv fordeling. 
