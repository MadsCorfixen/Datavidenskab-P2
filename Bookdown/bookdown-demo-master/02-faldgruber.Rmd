...
En estimator er en stikprøvefunktion, der udfører en beregning på baggrund af værdier i en stikprøve, for at estimere parametrene i en population. Eksempelvis er middelværdi, $\mathrm{middel} = \frac{\mathrm{\#sucesser}}{\mathrm{\#observationer}}$, en estimator, der beregner et estimat for en populations middelværdi.
...
For at bestemme, hvor stor en stikprøve der skal benyttes, for at stikprøvegennemsnittet bliver normalfordelt, benyttes 'Cochrans regel', som siger, at stikprøvestørrelsen, $n$, skal ligge i intervallet $[25 \cdot (\mathrm{skævhed})^2, 100 \cdot (\mathrm{skævhed})^2]$.


## Passende antal kovariater 

Hvis man vil lave en analyse af mænd og kvinders indkomst på arbejdsmarkedet, vil det give mening at tilføje en variabel, der måler på arbejdserfaring, da den vil kunne antages at have en indflydelse på indkomsten. Den variabel, som tilføjes, der måler arbejdserfaring, kaldes for en kovariat, og bruges til at beskrive indkomsten, som kaldes for responsvariablen.

For eksempel med indkomsten mellem mænd og kvinder, kan det siges at mere arbejdserfaring har positiv indflydelse på indkomsten. Hvis mænd tenderer til at have mere arbejdserfaring end kvinder, vil resultatet ændre sig, afhængig af om man kontroller for variablen arbejdserfaring.
